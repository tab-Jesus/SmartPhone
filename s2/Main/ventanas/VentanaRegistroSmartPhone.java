 ...
 * @author JESUS DAVID
 */
public class VentanaRegistroSmartPhone extends javax.swing.JDialog {

    /**
     * Creates new form VentanaRegistroUsuarios
     */
    public VentanaRegistroSmartPhone(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("REGISTRAR SMARTPHONE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaRegistroSmartPhone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaRegistroSmartPhone dialog = new VentanaRegistroSmartPhone(new javax.swing.JFrame(), true);
